...
train_log = train_log[(train_log['dataset_name'] == '2018-12-31_18') &
                      (train_log['act_func'] == 'sigmoid') &
                      (train_log['likelihood'] == 'pois') &
                      #(train_log['latent_dim'] == 128) &
                      #(train_log['encoder_dims'] == 128) &
                      #(train_log['num_epochs'] == 40) &
                      (train_log['batch_size'] == 1024) &
                      (train_log['learning_rate'] == 0.002)]
...
x_column = 'num_epochs'
y_column = 'score'
hypp_column = ['latent_dim', 'encoder_dims']
